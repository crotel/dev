 ...
 document.querySelector("section.footers  p").innerHTML = `© Copyright ${cryear} Crotel - All Rights Reserved`;
 ...
 fetch('https://crotel.me/data/')
     ...
     .then(function (json) {
         for (var i = 0; i < json.posts.length; i++) {
             ...
             fgpListItem.innerHTML = "<div class='timeline-date-panel col-xs-12 col-md-6 align-left'>" + "<div class='time-line-date-content' style='padding-bottom: 2em;'>" + "<p class='animated fadeInRight timeline-date fonts-style display-5' style='float: left;padding: 5px;border: 1px solid #b7b7b7;color: #b7b7b7;border-left-width: 0;border-top-width: 0;margin-bottom: -2em;'>" + publishTime + '<br>' + '</p>' + '</div>';
             //fgpListItem.innerHTML += "<span class='iconBackground'>" + '</span>';
             fgpListItem.innerHTML += "<div class='col-xs-12 col-md-6 align-right animated fadeInLeft' style='padding-bottom: 3.5em;'>" + "<div class='timeline-text-content'>" + "<h4 class='timeline-title pb-3 fonts-style display-5' style='font-size: 1.5em;line-height: 3em;letter-spacing: 0.03em;'>" + json.posts[i].title + '<br>' + '</h4>' + "<p class='animated fadeIn timeline-text fonts-style display-7 align-left' style='font-size: 1em;line-height: 2em;letter-spacing: 0.1em;'>" + plaintext + '<br>' + '</p>' + '</div>' + '</div>';
